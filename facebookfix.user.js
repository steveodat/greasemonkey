...
document.addEventListener("DOMContentLoaded", function() {
    ...
    addGlobalStyle('#pagelet_ego_pane, #pagelet_ego_pane_w, #pagelet_side_ads, #fbDockChatBuddylistNub, #pagelet_friends_online, #listsNav, #interestsNav, #appsNav, #pagesNav, #pagelet_sidebar, #pagelet_dock, #pagelet_rhc_footer, #developerNav, .noshowdy {display: none!important;}');
